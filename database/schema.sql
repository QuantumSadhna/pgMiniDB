...
REFERENCES public."BirthLocation"(id) MATCH FULL ON DELETE RESTRICT ON
UPDATE CASCADE,
CONSTRAINT "Director_Movie_fk" FOREIGN KEY ("id_Movie")
REFERENCES public."Movie"(id) MATCH SIMPLE ON DELETE SET NULL ON UPDATE
CASCADE,
CONSTRAINT "Director_University_fk" FOREIGN KEY ("id_University")
REFERENCES public."University"(id) MATCH SIMPLE ON DELETE SET NULL ON
UPDATE CASCADE
);
...
REFERENCES public."BirthLocation"(id) MATCH FULL ON DELETE CASCADE ON
UPDATE CASCADE
);
...
id smallint NOT NULL GENERATED ALWAYS AS IDENTITY,
"id_University" smallint NOT NULL UNIQUE, -- Unique constraint ensures one-to-
one relationship
name VARCHAR NOT NULL,
CONSTRAINT "Department_pk" PRIMARY KEY (id),
CONSTRAINT "Department_University_fk" FOREIGN KEY ("id_University")
REFERENCES public."University"(id) MATCH SIMPLE ON DELETE CASCADE ON UPDATE
CASCADE
);
...
REFERENCES public."Movie"(id) MATCH FULL ON DELETE RESTRICT ON UPDATE
CASCADE,
CONSTRAINT "MovieActor_Actor_fk" FOREIGN KEY ("id_Actor")
REFERENCES public."Actor"(id) MATCH FULL ON DELETE RESTRICT ON UPDATE
CASCADE
);
...
REFERENCES public."Genre"(id) MATCH FULL ON DELETE RESTRICT ON UPDATE
CASCADE
);
...
REFERENCES public."Cinema"(id) MATCH FULL ON DELETE CASCADE ON UPDATE
CASCADE
);
...
REFERENCES public."Ticket"(id) MATCH FULL ON DELETE CASCADE ON UPDATE
CASCADE,
CONSTRAINT "ShowTime_Movie_fk" FOREIGN KEY ("id_Movie")
REFERENCES public."Movie"(id) MATCH FULL ON DELETE CASCADE ON UPDATE
CASCADE
);
...
REFERENCES public."Award"(award_id) MATCH FULL ON DELETE CASCADE ON UPDATE
CASCADE
);
